...
namespace quanergy
{
	namespace client
	{
		...
		struct DLLEXPORT DataPacketParserM8 : public DataPacketParser
		{
			...
			void setCloudSizeLimits(int32_t szmin, int32_t szmax);
		...
		protected:
			...
			uint64_t previous_packet_stamp_ = 0;
			...
			/// cloud size limits
			int32_t minimum_cloud_size_ = 1;
			int32_t maximum_cloud_size_ = 1E6; // excessively large but protects memory usage
